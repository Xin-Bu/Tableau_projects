...
A collection of interactive data visualizations and executive dashboards hosted on Tableau Public, demonstrating advanced visual analytics, time-series forecasting, and dashboard UI/UX design.

---

## 🛍️ Project 1: E-commerce Analysis
...
## 📈 Project 2: One-Year Stock Performance
...
### 🧰 Analytical Toolset Featured
* Advanced calculations (LOD expressions like `FIXED`, `INCLUDE`)
* Dashboard actions (Filter, Highlight, URL actions)
* Custom color palettes and layout containers for clean, professional alignment
